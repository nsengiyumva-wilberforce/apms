...
<div class="content-wrapper shadow card round">
    ...
    <div class="row mb-5">
        ...
        <div class="col-6 m-3" id="temp_line_chart" style="width: 760px; height: 500px;border-radius: 10px">
</div>
    <div class="col-6 m-3" id="water_bar_chart" style="width: 760px; height: 500px;border-radius: 10px">
    </div>
        </div>
    </div>
