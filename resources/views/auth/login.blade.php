...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="{{ asset('dash/APMS_logo.png') }}">
    <!--===============================================================================================-->
...
<body  style="background-image: url('images/poultry.jpeg');background-size: 1920px 1000px;">
                    ...
                    <form class="login100-form validate-form" method="POST" action="{{route('auth.login')}}" >
                        ...
                        <span class="login100-form-logo">
                            <div class="login100-form-logo-img">
                                <figure>
                                    <a href="/" ><img src="{{ asset('dash/APMS_logo.png' ) }}" alt="APMS_logo" width="100" height="60"></a>
                        ...
                        <div class="container-login100-form-btn">
                            ...
                            <button class="btn text-light">
                                Don't have an account ?<a href="{{ route('auth.register') }}" class="lead text-light">{{ __('Register') }}</a>
                            </button>
                        </div>
                            </div>
                    </form>
